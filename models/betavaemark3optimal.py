...
beta = np.ones(500) * 1e-1
beta[:50] = np.linspace(0,49,50) * 1e-1/50

#model = BetaVAEMark3(latent_dim = 256) 
#model.load_state_dict(torch.load(f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/l256_b1/weights/BetaVAEMark3_weights_epoch100.pth"))
#tools.train(project_name = "BetaVAEMark3Optimal", model = model,
#        weights_directory_path=f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/weights",
#        training_losses_directory_path=f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/training_losses",
#        beta = beta, epochs = 500)
model = BetaVAEMark3(latent_dim = 256,log_clamping= False).to(device)
model.load_state_dict(torch.load(f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/weights/BetaVAEMark3Optimal_weights_epoch200.pth", map_location=torch.device('cpu')))
tools.test(model = model,
        signal_acceptance_directory = f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/signal_acceptance_rates",
        phi_invariance_study_directory=f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/phi_invariance_study",
        latent_code_directory=f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/latent_vectors",
        testing_losses_directory=f"/home/xzcapask/atlas_ad_hllhc/data/model_data/BetaVAEMark3/optimal/testing_losses")